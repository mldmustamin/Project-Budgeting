...
class ValidateTransactionUseCaseTest {
    ...
    private class FakeFundsRepository : FundsRepository {
        ...
        override suspend fun updateProjectSchedule(id: Long, startAt: Long, completedAt: Long?) = Unit
        ...
        override suspend fun softDeleteAccount(id: Long) = Unit
        ...
        override suspend fun softDeleteCategory(id: Long) = Unit
