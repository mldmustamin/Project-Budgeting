...
fun ProjectEntity.toDomain(): Project = Project(id, name, description, isArchived)
fun Project.toEntity(userId: Long): ProjectEntity = ProjectEntity(id, userId, name, description, isArchived)
...
fun AttachmentEntity.toDomain(): Attachment = Attachment(
    id, transactionId, filePath, fileName, mimeType, createdAt
)
